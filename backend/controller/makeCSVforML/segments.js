    ...
    do {
        ...
        do {
            ...
            segments.push({
                ...
                time: params['rideduration'] ? params['rideduration'] * 60 * 60 : Math.round(segment.timedif) / 1000,
...
function buildSegments2(params, trackinfo, segsize) {
    ...
    for (var i = 0; i < split.length; i++) {
        ...
        segments.push({
            ...
            time: params['rideduration'] ? params['rideduration'] * 60 * 60 : Math.round(segtime * 100) / 100,
